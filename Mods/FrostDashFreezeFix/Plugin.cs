...
public class Plugin : BasePlugin
{
    ...
    // ///
    // /// .frostdashfreezefix-example "some quoted string" 1 1.5
    // /// .frostdashfreezefix-example boop 21232
    // /// .frostdashfreezefix-example boop-boop
    // ///</remarks>
    // [Command("frostdashfreezefix-example", description: "Example command from frostdashfreezefix", adminOnly: true)]
