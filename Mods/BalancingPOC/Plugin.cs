...
public class Plugin : BasePlugin
{
    ...
    // ///
    // /// .balancingpoc-example "some quoted string" 1 1.5
    // /// .balancingpoc-example boop 21232
    // /// .balancingpoc-example boop-boop
    // ///</remarks>
    // [Command("balancingpoc-example", description: "Example command from balancingpoc", adminOnly: true)]
