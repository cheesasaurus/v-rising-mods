...
namespace cheesasaurus.VRisingMods.AbilityHooksPOC;
...
public class Plugin : BasePlugin
{
    ...
    // ///
    // /// .abilityhookspoc-example "some quoted string" 1 1.5
    // /// .abilityhookspoc-example boop 21232
    // /// .abilityhookspoc-example boop-boop
    // ///</remarks>
    // [Command("abilityhookspoc-example", description: "Example command from abilityhookspoc", adminOnly: true)]
