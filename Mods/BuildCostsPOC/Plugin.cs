...
public class Plugin : BasePlugin
{
    ...
    // ///
    // /// .buildcostspoc-example "some quoted string" 1 1.5
    // /// .buildcostspoc-example boop 21232
    // /// .buildcostspoc-example boop-boop
    // ///</remarks>
    // [Command("buildcostspoc-example", description: "Example command from buildcostspoc", adminOnly: true)]
